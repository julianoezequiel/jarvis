...
import { ChatMessage } from '../../hooks/useMayaChat'
    ...
    <div className="p-6 min-h-screen bg-[#020609] text-white">
      <div className="max-w-3xl mx-auto">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link href="/" className="text-mayaCyan underline">Voltar</Link>
        </div>
        {messages.length === 0 ? (
          ...
          <div className="flex flex-col gap-3">
            {messages.map((m) => (
              <div key={m.id} className="p-3 rounded border bg-black/30 border-mayaCyan/10">
                <div className="text-sm text-mayaCyan/70 uppercase tracking-wider">{m.role}</div>
